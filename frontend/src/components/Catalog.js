          ...
          <svg width="306" height="125" viewBox="0 0 306 125" fill="none" xmlns="http://www.w3.org/2000/svg">
            <foreignObject x="-19.5" y="-19.5" width="344.522" height="164.454">
              <div
                ...
                style={{
                  backdropFilter: 'blur(20px)', // CamelCase for backdrop-filter
                  clipPath: 'url(#bgblur_0_392_1044_clip_path)', // Reference to clipPath
                  height: '100%',
                  width: '100%',
                  // Fallback for browsers that don’t support backdrop-filter
                  backgroundColor: 'rgba(255, 255, 255, 0.1)', // Matches fill-opacity
                }}
              />
            </foreignObject>
            <path
